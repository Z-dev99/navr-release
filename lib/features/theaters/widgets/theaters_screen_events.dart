...
class TheatersScreenEvents extends StatelessWidget {
  final TheatersResponse events;
  const TheatersScreenEvents({super.key, required this.events});
